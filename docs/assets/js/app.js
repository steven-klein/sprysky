...
var bs = {};
var gallery = jquery$1('#gallery');
var imgBox = jquery$1('#gallery-full');

bs.closeGal = function(){
	gallery.removeClass('active');
	jquery$1('#gallery-full img.show').removeClass('show');
...
bs.getImage = function(e){
	e.preventDefault();
	jquery$1('#gallery-full .show').removeClass('show');
	bs.setPos(jquery$1(this));

	if(!gallery.hasClass('active')){
		gallery.addClass('active');
	}

	var url = jquery$1(this).attr('href');
	var id = jquery$1(this).data('id');

	//did we already get this image
	if(jquery$1('#gallery-full #img-' + id).length == 0){
		var img = "<img id='img-"+ id +"' src='" + url + "'/>";
		imgBox.append(img);
		jquery$1(img).bind('load', function(){
			bs.showImage('#img-' + id);
		});
	}else{
		bs.showImage('#img-' + id);
...
bs.showImage = function(img){
	jquery$1(img).addClass('show');
};

bs.galleryInit = function() {
    jquery$1('#gallery').on('click', 'a', bs.getImage);
    jquery$1('.close-img').on('click', bs.closeGal);
};

jquery$1(document).ready(bs.galleryInit);
